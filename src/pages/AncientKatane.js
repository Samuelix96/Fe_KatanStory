...
import '../components/style/ancient.scss';
...
const AncientKatane = () => {
  ...
  const [addAncient, { ilLoading }] = useAddKataneMutation();
  ...
  return (
    <MainLayout>
      <motion.div
        ...
        animate={{ width: '100%' }}
        exit={{ width: 0 }}>
        <div className='sfondo-ancient content'>
          <h1 className='h1-new'>
            <span class='left'>Ancient-</span>

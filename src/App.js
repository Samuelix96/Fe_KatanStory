      ...
      <Router>
        <Routes>
          ...
          <Route element={<ProtectedRoutes />}>
            ...
            />
            <Route
              path='/detailkatane/:idkatane'
              element={<DetailKatane />}
            />
            <Route
              path='/detailarmor/:idarmor'
              element={<DetailArmor />}
            />
            <Route
              path='/detailsupport/:idsupport'
              element={<DetailSupport />}
            />
            <Route
              path='/detailhelmet/:idhelmet'
              element={<DetailHelmet />}
            />

    ...
    <Navbar
      ...
      <Container fluid>
        <Navbar.Brand
          ...
          />
          <a
            className=' link-underline link-underline-opacity-0 text-info  rounded-2 mx-2'
            href='/'>
            {' '}
            KATANSTORY
          </a>
        ...
        <Navbar.Collapse
          ...
          <Nav
            ...
            <Link
              className=' contact_nav link-underline link-underline-opacity-0 p-3 text-dark fs-5 mx-2'
              to={`/contact`}>
              Contact
            </Link>

            <NavDropdown
              className='fs-5 text-dark kata_nav '
              title='Katana'
              id='navbarScrollingDropdown'>
              <NavDropdown.Item>
                <Link
                  className=' text-dark link-underline link-underline-opacity-0  text-dark fs-7 '
                  to={`/newkatane`}>
                  New Katane
                </Link>
              </NavDropdown.Item>
              <NavDropdown.Item>
                <Link
                  className='link-underline  link-underline-opacity-0  text-dark fs-7 '
                  to={`/ancientkatane`}>
                  Ancient Katana
                </Link>
              </NavDropdown.Item>
            ...
            <NavDropdown
              className='fs-5 text-dark equi_nav'
              title='Equipment'
              id='navbarScrollingDropdown'>
              <NavDropdown.Item>
                <Link
                  className='p-3 link-underline link-underline-opacity-0  text-dark fs-5 mx-2'
                  to={`/armor`}>
                  Armor
                </Link>
              </NavDropdown.Item>
            ...
            <Link
              className='p-3 museum_nav link-underline link-underline-opacity-0  text-dark fs-5 mx-2'
              to={`/museum`}>
              Museum
            </Link>
          ...
          <Dropdown
            ...
            <Dropdown.Toggle
              ...
              />
              {numbWish > 0 && (
                <Badge className=' position-absolute cart-badge'>
                  {numbWish}
                </Badge>
              )}
            </Dropdown.Toggle>
            <Dropdown.Menu>
              ...
              <div className='d-flex justify-content-between  my-2'>
                <Dropdown.Item>
                  <Button className=' btn-info btn-outline-secondary'>
                    <Link
          ...
          <Dropdown
            ...
            <Dropdown.Menu>
              ...
              <div className='d-flex justify-content-between my-2'>
                <Dropdown.Item>
                  <Button className=' btn-secondary btn-outline-warning'>
                    <Link
                      className='link-underline link-underline-opacity-0 text-dark'
                      to={`/cartshop`}>
                      Go to Cart 🛒
